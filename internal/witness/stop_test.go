...
func (m *mockTmux) GetSessionInfo(string) (*tmux.SessionInfo, error) {
	return &tmux.SessionInfo{}, nil
}
func (m *mockTmux) GetSessionCreatedUnix(string) (int64, error) { return 0, nil }

func TestStop_KillsSession(t *testing.T) {
	mock := &mockTmux{hasSession: true}
	m := &Manager{rig: &rig.Rig{Name: "wyvern", Path: t.TempDir()}, tmux: mock}
